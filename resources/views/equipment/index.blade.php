...
@section('content')
<div class="stack" id="equipment-app" v-cloak>
    <div class="page-head">
        <div>
            <h1>Оборудование</h1>
...
createApp({
    setup() {
        ...
        return { items, modalOpen, isEditing, form, canSave, openCreateModal, openEditModal, closeModal, saveItem, deleteItem, formatPrice, formatDate };
    }
}).mount('#equipment-app');
</script>
@endsection
